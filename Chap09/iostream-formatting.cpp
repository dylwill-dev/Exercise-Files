...
int main() {
    ...
    // // This version takes in one word at a time only using cin
    // std::string istr {};
    // std::cout << "Prompt: ";
    // std::cin >> istr;    // one word at a time
    // std::cout << "Input: " << istr << '\n';

    // This version uses cin.getLine that takes a buffer (character array) and can grab the entire input.
    // char buf[128] {};
    // std::cout << "Prompt: ";
